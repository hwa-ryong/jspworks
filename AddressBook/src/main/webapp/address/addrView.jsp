...
<body>
	<div id="container">
		...
		<table id="tbl_view">
			...
			<tr>
				<td>전화번호</td>
				<td><input type="text" name="tel" readonly="readonly" value="<%=aB.getTel() %>"></td>
			</tr>
			<tr>
				<td>이메일</td>
				<td><input type="text" name="email" readonly="readonly" value="<%=aB.getEmail() %>"></td>
			</tr>
			<tr>
				<td>성별</td>
				<td><input type="text" name="email" readonly="readonly" value="<%=aB.getGender() %>"></td>
			</tr>
			<tr>
				<td colspan="2">
